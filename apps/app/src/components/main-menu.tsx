...
export const MainMenu = () => {
  ...
  return (
    <nav>
      <ul>
        <MenuItem isActive={segment === null} href={`/${teamSlug}`} icon="home" label="Home" />
        <MenuItem isActive={segment === 'settings'} href={`/${teamSlug}/settings`} icon="settings" label="Settings" />
      </ul>
    </nav>
  )
}
