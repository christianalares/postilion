// Generated by Wrangler by running `wrangler types` (hash: 780b29849c59312f37f9ba84285c63a2)
// Runtime types generated with workerd@1.20250310.0 2025-03-07 
interface Env {
	DATABASE_URL: string;
	DATABASE_URL_OLD: string;
	MESSAGE_STATUS: DurableObjectNamespace<import("./src/index").MessageStatus>;
	SEND_EMAIL: SendEmail;
	AI: Ai;
	INBOUND_EMAIL_WORKFLOW: Workflow;
}
