// Generated by Wrangler by running `wrangler types` (hash: 8f20d8819f17dcab66905c2c0434c363)
// Runtime types generated with workerd@1.20250310.0 2025-03-07 nodejs_compat
interface Env {
	DATABASE_URL: string;
	APP_URL: string;
	DEV: string;
